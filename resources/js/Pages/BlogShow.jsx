                ...
                <main className="bg-white text-gray-950">
                        ...
                        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                            <div className="overflow-hidden rounded-2xl bg-blue-50 shadow-sm">
                                {post.cover_image ? (
                                    ...
                                    <div className="flex h-80 items-center justify-center text-brand">
                    ...
                    <RevealSection className="bg-white py-16 sm:py-20">
                        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                            {safeBodyHtml ? (
                                <div
                                    className="space-y-6 text-lg leading-8 text-gray-700 [&_a]:text-brand [&_a]:underline [&_blockquote]:border-l-4 [&_blockquote]:border-blue-200 [&_blockquote]:pl-4 [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:font-black [&_h3]:mt-7 [&_h3]:text-xl [&_h3]:font-black [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-6 [&_p]:mb-4 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6"
                        ...
                        <RevealSection className="bg-gray-50 py-16 sm:py-20 lg:py-24">
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                                    <div>
                                        <p className="text-sm font-black uppercase tracking-[0.22em] text-brand">Keep Reading</p>
                                        <h2 className="mt-3 text-3xl font-black tracking-tight text-gray-950">Related articles</h2>
                                    </div>
                                    <Link href="/blog" className="inline-flex items-center gap-2 text-sm font-black text-brand">
                                        View all posts
                                ...
                                <Stagger className="mt-10 grid gap-6 lg:grid-cols-3">
                                    {relatedPosts.map((item) => (
                                        <StaggerItem as="article" key={item.id} className="bg-white p-6 shadow-sm ring-1 ring-gray-200">
                                            <p className="text-xs font-black uppercase tracking-[0.18em] text-brand">{item.category}</p>
                                            ...
                                            <Link href={item.url} className="mt-6 inline-flex items-center gap-2 text-sm font-black text-brand">
                                                Read article
                                                <ArrowRightIcon className="h-4 w-4" />
                                            </Link>
                                        </StaggerItem>

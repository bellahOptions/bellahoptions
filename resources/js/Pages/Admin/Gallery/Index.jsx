...
const fields = [
    ...
    { name: "image_upload", label: "Upload Project Image", type: "file", accept: "image/*", className: "md:col-span-2" },
    { name: "image_path", label: "Image URL or Public Path (Optional)", placeholder: "/images/sample.jpg", summary: true },

...
<head>
    ...
    <title>THanks for reserving a spot </title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px; background:#ffffff; border-radius:20px; overflow:hidden; border:1px solid #dbeafe; box-shadow:0 24px 60px rgba(30,64,175,0.14);">
                    ...
                    <tr>
                        <td style="padding:28px 30px 12px;">
                            ...
                            <a href="{{ config('app.url') }}" style="display:inline-block; background:#1d4ed8; color:#ffffff; text-decoration:none; align:center; font-size:14px; font-weight:700; letter-spacing:0.01em; padding:12px 20px; border-radius:10px;">
                                Join our Whatsapp business Community
                            </a>
                        </td>
                    </tr>
                    <tr>

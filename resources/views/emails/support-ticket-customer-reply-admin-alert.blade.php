...
<head>
    ...
    <title>Customer Replied to Ticket</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px; background:#ffffff; border:1px solid #e5e7eb; border-radius:12px;">
                    <tr>
                        <td style="padding:24px;">
                            <h2 style="margin:0 0 12px; font-size:20px; color:#0f172a;">Customer Reply Alert</h2>
                            <p style="margin:0 0 12px; font-size:14px; line-height:1.7;">A customer has replied to support ticket {{ $ticket->ticket_number }}.</p>

...
class SupportTicketCreatedAdminAlertMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: $this->resolveTemplateSubject(
                ...
                sprintf('New Support Ticket: %s', $this->ticket->ticket_number),
                $this->templateFields(),
            ),
            from: $this->resolveTemplateFromAddress('support_ticket_created_admin_alert', $senderEmail, $senderName),
        );
    }
    ...
    public function content(): Content
    {
        return $this->resolveTemplateContent(
            'support_ticket_created_admin_alert',
            'emails.support-ticket-created-admin-alert',
            $this->templateFields(),
        );
    }

...
class AbandonedOrderProspectAdminAlertMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: sprintf('Abandoned order prospect: %s', (string) ($this->prospect->email ?: $this->prospect->phone ?: 'unknown')),
    ...
    {
        return new Content(
            view: 'emails.abandoned-order-prospect-admin-alert',
            with: [
